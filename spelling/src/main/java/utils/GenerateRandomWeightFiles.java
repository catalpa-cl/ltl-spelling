...
// Generate random weight matrixes to use for testing of levenshtein-based candidate generation methods
public class GenerateRandomWeightFiles {
	...
	private final static Character[] alphabet_DE = new Character[] { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j',
			'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z', 'ä', 'ö', 'ü', 'ß', 'è',
			'é', 'ê', 'ç', 'ñ', 'à', 'á', 'â' };
	...
	private final static Character[] alphabet_DE_upper = new Character[] { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i',
			...
			'è', 'é', 'ê', 'ç', 'ñ', 'à', 'á', 'â', 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L', 'M',
