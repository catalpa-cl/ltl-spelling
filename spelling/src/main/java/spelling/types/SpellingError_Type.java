...
public class SpellingError_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("spelling.types.SpellingError");
  ...
  public String getCorrection(int addr) {
      ...
      jcas.throwFeatMissing("correction", "spelling.types.SpellingError");
  ...
  public String getErrorType(int addr) {
      ...
      jcas.throwFeatMissing("errorType", "spelling.types.SpellingError");
