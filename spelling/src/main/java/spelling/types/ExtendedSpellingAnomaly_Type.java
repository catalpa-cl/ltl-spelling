...
public class ExtendedSpellingAnomaly_Type extends SpellingAnomaly_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("spelling.types.ExtendedSpellingAnomaly");
  ...
  public boolean getCorrected(int addr) {
      ...
      jcas.throwFeatMissing("corrected", "spelling.types.ExtendedSpellingAnomaly");
  ...
  public String getMisspelledTokenText(int addr) {
      ...
      jcas.throwFeatMissing("misspelledTokenText", "spelling.types.ExtendedSpellingAnomaly");
  ...
  public String getMethodThatGeneratedTheCorrection(int addr) {
      ...
      jcas.throwFeatMissing("methodThatGeneratedTheCorrection", "spelling.types.ExtendedSpellingAnomaly");
  ...
  public String getGoldStandardCorrection(int addr) {
      ...
      jcas.throwFeatMissing("goldStandardCorrection", "spelling.types.ExtendedSpellingAnomaly");
  ...
  public String getSpellingEngineCorrection(int addr) {
      ...
      jcas.throwFeatMissing("spellingEngineCorrection", "spelling.types.ExtendedSpellingAnomaly");
